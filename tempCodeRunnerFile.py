...
class Drink(db.Model):
    ...
    # Goal: ensure that the ingredients are a list.. I want the code on the HTML file to appear as a bulleted list.. but I want the ingredients to be stored in the dataframe as a list.. 
